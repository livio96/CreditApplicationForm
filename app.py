...
api_key = "bGJlcWlyaUB0ZWxxdWVzdGludGwuY29tOjFfSDctPjB1Um5pQlZZRSc1NTVqZSZyZVxwb350Zw=="
...
def index():
    if request.method == 'POST':
        ...
        authentication_url = "https://api.eulerhermes.com/v1/idp/oauth2/authorize"
        ...
        search_company_url = "https://api.allianz-trade.com/search/v2/companies/matching"
...
def search_jobid(JobId, token):
    ...
    # search_job_url = 'https://api-services.uat.1placedessaisons.com/uatm/riskinfo/v3/jobs/' + JobId
    search_job_url = 'https://api.allianz-trade.com/riskinfo/v3/jobs/' + JobId
    payload = {}
    headers  = {'Content-Type': 'application/json', 'Authorization': token}
    time.sleep(50)
...
def cover_request():
    if request.method == 'POST':
        ...
        cover_request_url = "https://api.allianz-trade.com/riskinfo/v3/covers"
        token = session.get('token')
